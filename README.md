...
I am currently working on an English document. [Click here](https://github.com/sakana3/PolyQuilt/releases/download/1.1.3/PolyQuilt_v1.1.3.zip) to download the latest version.
...
最新版ダウンロードは[こちら](https://github.com/sakana3/PolyQuilt/releases/download/1.1.3/PolyQuilt_v1.1.3.zip)から
