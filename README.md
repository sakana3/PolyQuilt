...
- とても重いです。一般的なPCだと1万ポリゴンぐらいからガクガクしてイラッとすると思います。一応対応の目途は立っていますが今のところは我慢して5000ポリゴンぐらいで編集してください
- Blenderを再起動するとキーマップが外れてしまいます。再起動した時は環境設定のアドオンからPolyQuiltを再度チェックしてください。[こちら](https://developer.blender.org/T60766)の修正待ちです
- 今のところカスタムアイコンを反映させる機能がないのでPolyBuildのアイコンになっています。ややこしくてすみません
- マルチオブジェクト編集をすると盛大に落ちます。これも対応待ちです。
...
編集モードに入るとPolyBuildの下にアイコンが追加されているのでこれをクリックでPolyQuiltが使えるようになります。
