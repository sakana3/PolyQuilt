...
- とても重いです。一般的なPCだと1万ポリゴンぐらいからガクガクしてイラッとすると思います。一応対応の目途は立っていますが今のところは我慢して5000ポリゴンぐらいで編集してください。１０万ポリゴンを超えるオブジェクトに適用すると操作不能になる恐れがあります
- Blenderを再起動するとキーマップが外れてしまいます。お手数ですが再起動した時は環境設定のアドオンからPolyQuiltを再度チェックしてください。[こちら](https://developer.blender.org/T60766)の修正待ちです
